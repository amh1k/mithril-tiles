...
func (app *application) routes() http.Handler {
	...
	router.HandlerFunc(http.MethodDelete, "/v1/users/delete/:id", app.requireRegisteredUser(app.deleteUserHandler))
	router.HandlerFunc(http.MethodPatch, "/v1/users/update/:id", app.requireRegisteredUser(app.updateUserHandler))
