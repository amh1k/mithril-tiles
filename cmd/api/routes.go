...
func (app *application) routes() http.Handler {
	...
	router.HandlerFunc(http.MethodPost, "/v1/word-packs/:id/words", app.requireRegisteredUser(app.requireAdminUser(app.createWordHandler)))
	...
	router.HandlerFunc(http.MethodPatch, "/v1/words/:id", app.requireRegisteredUser(app.requireAdminUser(app.updateWordHandler)))
	router.HandlerFunc(http.MethodPost, "/v1/words/:id", app.requireRegisteredUser(app.requireAdminUser(app.createWordHandler)))
	router.HandlerFunc(http.MethodDelete, "/v1/words/:id", app.requireRegisteredUser(app.requireAdminUser(app.deleteWordHandler)))
